    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card shadow rounded-4">
                ...
                <div class="card-body">
                    <a href="{{ route('konsultan.consultations.create') }}" class="btn btn-primary mb-3">+ Buat Konsultasi</a>
                    <a href="{{ route('konsultan.dashboard') }}" class="btn btn-secondary mb-3">Kembali</a>
                    <style>
                        .table-custom-border,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($consultation->status === 'proses')
                                            <span style="display: inline-block; width: 15px; height: 15px; background-color: #0dcaf0; border-radius: 3px;"></span>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('konsultan.consultations.edit', $consultation) }}" 
                                               class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('konsultan.consultations.destroy', $consultation) }}" 
        ...
        <div class="col-lg-6">
            <div class="card shadow rounded-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <span style="display: inline-block; width: 15px; height: 15px; background-color: #0dcaf0; border-radius: 3px; margin-right: 10px;"></span>
