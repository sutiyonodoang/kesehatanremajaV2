    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow rounded-4">
                ...
                <div class="card-body">
                    <a href="{{ route('user.consultations.create') }}" class="btn btn-primary mb-3">+ Buat Konsultasi</a>
                    <a href="{{ route('user.dashboard') }}" class="btn btn-secondary mb-3">Kembali</a>
                    <style>
                        .table-custom-border,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('user.consultations.show', $consultation) }}" 
                                               class="btn btn-sm btn-info">
                                                <i class="fas fa-eye"></i> Lihat
                                            </a>
                                            <a href="{{ route('user.consultations.edit', $consultation) }}" 
                                               class="btn btn-sm btn-warning @if($consultation->status !== 'menunggu') disabled @endif"
                                               @if($consultation->status !== 'menunggu') aria-disabled="true" tabindex="-1" @endif>
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('user.consultations.destroy', $consultation) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus konsultasi ini?')" @if($consultation->status !== 'menunggu') disabled @endif>
            ...
            <div class="card shadow rounded-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <span>Diproses: Konsultan sudah memberi respon.</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
