...
.hero .btn-primary:hover {
    background:rgb(60, 105, 173); /* warna hover yang lebih gelap */
}
...
<body>
    ...
    <main class="hero d-flex flex-column justify-content-center">
        <div class="container">
            ...
            <p class="lead mb-4" style="text-shadow: 0 1px 2px rgba(0,0,0,0.5); max-width: 700px; margin: auto;">
                Pelajari dasar-dasar kesehatan dengan mudah dan menyenangkan melalui materi dan video interaktif khusus untuk Anda.
            </p>
        ...
        <div class="container text-center">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <p>
                    Akses beragam modul edukasi kesehatan seperti Pola Hidup Sehat, Reproduksi dan Kesehatan Mental yang mudah dipahami dan selalu diperbarui.                    </p>
                </div>
                <div class="col-md-6">
                    <div class="feature-icon">🎥</div>
    ...
    <section id="about" class="container text-white text-center mb-5">
        ...
        <p style="max-width: 800px; margin: auto; line-height: 1.6; text-shadow: 0 1px 3px rgba(0,0,0,0.5);">
            SmartHealth berdedikasi untuk meningkatkan pengetahuan siswa tentang kesehatan melalui teknologi.
