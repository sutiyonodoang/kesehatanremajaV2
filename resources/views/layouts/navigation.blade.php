@php
    ...
    $dashboardRoute = $user ? match($user->role) {
        ...
        'konsultan' => 'konsultan.dashboard',
        default => 'user.dashboard'
    } : null;
    
    $profileEditRoute = $user ? match($user->role) {
        'admin' => 'admin.profile.edit',
        'konsultan' => 'user.profile.edit', // Using user profile for now
            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route($profileEditRoute)">
                                {{ __('Profile') }}
                            </x-dropdown-link>
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route($profileEditRoute)">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
